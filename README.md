...
**Note:** This repository is deprecated. The new version has been migrated to [differ.NET](https://github.com/caojiachen1/differ.NET), using Avalonia + .NET framework, with improved UI aesthetics and integrated more accurate DINOv3 algorithm.
